// ============================================================
// WalkSAT_Community_Break.cpp
// ============================================================

#include "WalkSAT_Community_Break.h"
...
double WalkSAT_Community_Break::
randDouble()
{
    ...
    int variable)
{
         ...
         variable_occurrences[variable])
    {
        ...
        // ----------------------------------------------------
        // Quitar contribución antigua a community_breakcount
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        // Añadir contribución nueva a community_breakcount
        // ----------------------------------------------------
