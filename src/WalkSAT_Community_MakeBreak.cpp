// ============================================================
// WalkSAT_Community_MakeBreak.cpp
// ============================================================
...
int WalkSAT_Community_MakeBreak::
...
double WalkSAT_Community_MakeBreak::
randDouble()
{
...
void WalkSAT_Community_MakeBreak::
randomAssignment()
{
    for (int v = 1;
         v <= num_variables;
    ...
    int variable)
{
         ...
         variable_occurrences[variable])
    {
        ...
        // ----------------------------------------------------
        // Quitar contribuciones antiguas de cláusulas comunitarias
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        // Añadir contribuciones nuevas de cláusulas comunitarias
        // ----------------------------------------------------
...
bool WalkSAT_Community_MakeBreak::
solve(
    int max_flips,
    int max_tries,
    double p,
