// ============================================================
// WalkSAT_Bridge_MakeBreak_PAWS_DET.h
// ============================================================
...
class WalkSAT_Bridge_MakeBreak_PAWS_DET : public ISolver {
public:
...
private:
    ...
    // bridge_makecount[v] =
    // weighted number of UNSAT bridge clauses that v can satisfy.
    ...
    void addBridgeMakeContribution(int clause);

    void removeBridgeMakeContribution(int clause);

    void adjustBridgeMakeContribution(int clause, int delta);
    ...
    // bridge_makecount[v] - bridge_breakcount[v]
