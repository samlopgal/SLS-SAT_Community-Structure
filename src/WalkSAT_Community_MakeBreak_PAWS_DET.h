// ============================================================
// WalkSAT_Community_MakeBreak_PAWS_DET.h
// ============================================================
...
class WalkSAT_Community_MakeBreak_PAWS_DET : public ISolver {
public:
...
private:
    ...
    // Only community clauses are weighted by this solver.
    // Non-community clauses remain irrelevant for the structure-aware score.
    ...
    // community_makecount[v] =
    // weighted number of UNSAT community clauses that v can satisfy.
    std::vector<int> community_makecount;

    // community_breakcount[v] =
    // weighted number of community clauses with true_literal_count == 1
    ...
    void addCommunityMakeContribution(int clause);

    void removeCommunityMakeContribution(int clause);

    void adjustCommunityMakeContribution(int clause, int delta);
    ...
    // community_makecount[v] - community_breakcount[v]
