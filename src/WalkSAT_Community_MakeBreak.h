...
class WalkSAT_Community_MakeBreak : public ISolver {
public:
...
private:
    ...
    // nº de cláusulas comunitarias UNSAT que v puede satisfacer
    ...
    void addCommunityMakeContribution(
        int clause
    );

    void removeCommunityMakeContribution(
        int clause
    );
