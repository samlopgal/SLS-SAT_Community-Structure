// ============================================================
// WalkSAT_Bridge_Break_PAWS_DET.cpp
// ============================================================

#include "WalkSAT_Bridge_Break_PAWS_DET.h"
...
int WalkSAT_Bridge_Break_PAWS_DET::
...
double WalkSAT_Bridge_Break_PAWS_DET::
randDouble()
{
...
void WalkSAT_Bridge_Break_PAWS_DET::
randomAssignment()
{
    for (int v = 1;
         v <= num_variables;
...
inline int WalkSAT_Bridge_Break_PAWS_DET::
...
void WalkSAT_Bridge_Break_PAWS_DET::resetWeightStatistics(int tracked_count)
{
...
void WalkSAT_Bridge_Break_PAWS_DET::noteWeightIncrease(int old_weight)
{
...
void WalkSAT_Bridge_Break_PAWS_DET::noteWeightDecrease(int old_weight)
{
    if (old_weight <= 1) {
        return;
    }
...
int WalkSAT_Bridge_Break_PAWS_DET::normalizeWeights()
{
    int decrements = 0;
    int i = 0;
...
int WalkSAT_Bridge_Break_PAWS_DET::countWeightedClauses() const
{
    return static_cast<int>(weighted_clauses.size());
}

int WalkSAT_Bridge_Break_PAWS_DET::maxClauseWeight() const
{
    return current_max_clause_weight;
}

double WalkSAT_Bridge_Break_PAWS_DET::meanClauseWeight() const
{
...
bool WalkSAT_Bridge_Break_PAWS_DET::
solve(
    int max_flips,
    int max_tries,
    double p,
