...
double WalkSAT_Bridge_MakeBreak::
randDouble()
{
    ...
    int variable)
{
         ...
         variable_occurrences[variable])
    {
        ...
        // ----------------------------------------------------
        // Quitar contribuciones antiguas de cláusulas puente
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        // Añadir contribuciones nuevas de cláusulas puente
        // ----------------------------------------------------
